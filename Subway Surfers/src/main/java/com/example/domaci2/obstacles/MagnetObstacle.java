...
public class MagnetObstacle extends ObstacleBody
{
    ...
    public MagnetObstacle(Position position)
    {
        super(position);
    }
    ...
    protected void createObstacleBody()
    {
        ...
        Box box1 = new Box(10, 14, 10);
        box1.setMaterial(new PhongMaterial(Color.RED));
        box1.setTranslateX(7);

        Box box2 = new Box(10, 14, 10);
        box2.setMaterial(new PhongMaterial(Color.BLUE));
        box2.setTranslateX(-7);
