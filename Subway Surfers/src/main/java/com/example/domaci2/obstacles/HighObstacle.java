...
public class HighObstacle extends ObstacleBody
{
    ...
    public HighObstacle(Position position)
    {
        super(position);
    }
    ...
    protected void createObstacleBody()
    {
        ...
        // additional parts
        Box leftPart1 = new Box(4, DEFAULT_OBSTACLE_DIMENSION, 4);
        leftPart1.setMaterial(OBSTACLE_MATERIAL);
        leftPart1.setTranslateX(-12);

        Box rightPart2 = new Box(4, DEFAULT_OBSTACLE_DIMENSION, 4);
        rightPart2.setMaterial(OBSTACLE_MATERIAL);
        rightPart2.setTranslateX(12);

        Group body1 = new Group(leftPart1, rightPart2);
        body.setTranslateY(-DEFAULT_OBSTACLE_DIMENSION);
        body1.getChildren().add(body);
