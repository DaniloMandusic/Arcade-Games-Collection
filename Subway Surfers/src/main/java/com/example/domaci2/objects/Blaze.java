...
import com.example.domaci2.obstacles.BlazeObstacle;
...
public class Blaze  extends GameObject {

    private static double OBSTACLE_SPEED = 4.0;

    private ObstacleBody obstacleBody;

    public Blaze(Position position)
    {
        super(position);

        obstacleBody = new BlazeObstacle(position);
